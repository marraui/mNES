...
Cpu6502::Cpu6502(
  ...
  this->lookup = {
    ...
    { "RTS", &a::RTS, "IMP", &a::IMP, 6, 1 }, { "ADC", &a::ADC, "IZX", &a::IZX, 6, 2 }, { "???", &a::XXX, "IMP", &a::IMP, 2, 2 }, { "???", &a::XXX, "IMP", &a::IMP, 2, 1 }, { "???", &a::XXX, "IMP", &a::IMP, 2, 1 }, { "ADC", &a::ADC, "ZP0", &a::ZP0, 3, 2 }, { "ROR", &a::ROR, "ZP0", &a::ZP0, 5, 2 }, { "???", &a::XXX, "IMP", &a::IMP, 2, 1 }, { "PLA", &a::PLA, "IMP", &a::IMP, 4, 1 }, { "ADC", &a::ADC, "IMM", &a::IMM, 2, 2 }, { "ROR", &a::ROR, "ACC", &a::ACC, 2, 1 }, { "???", &a::XXX, "IMP", &a::IMP, 2, 1 }, { "JMP", &a::JMP, "IND", &a::IND, 5, 3 }, { "ADC", &a::ADC, "ABS", &a::ABS, 4, 3 }, { "ROR", &a::ROR, "ABS", &a::ABS, 6, 3 }, { "???", &a::XXX, "IMP", &a::IMP, 2, 1 },
